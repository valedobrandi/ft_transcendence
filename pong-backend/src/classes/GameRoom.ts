...
class GameRoom {
	...
	resetBall() {
		...
		this.gameState.ball.velocityX = -this.initialBallSpeed;;
		this.gameState.ball.velocityY = this.initialBallSpeed;;
	}
	...
	updateGame() {
		...
		if (
			...
			ball.speed += this.initialBallSpeed;
			if (ball.speed > 0.05) {
				ball.speed = 0.05;
			}
		}
