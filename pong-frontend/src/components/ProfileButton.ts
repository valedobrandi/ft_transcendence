...
export function ProfileButton(): HTMLDivElement {
    ...
    buttonsDiv.className = "flex flex-col gap-10 mb-9 w-70";
    ...
    function onRender() {
        ...
        if (!isUserProfile) {
            ...
            friendButton.className = `px-10 py-4 rounded text-white text-xs font-semibold ${isFriend ? "bg-gray-400 opacity-50 cursor-not-allowed" : "bg-green-500 hover:bg-green-600"}`;
            ...
            removeFriendButton.className = `px-10 py-4 rounded text-white text-xs font-semibold ${isFriend ? "bg-red-500 hover:bg-red-600" : "bg-gray-400 opacity-50 cursor-not-allowed"}`;
            ...
            blockButton.textContent = isBlocked ? "MUTE/BLOCK MESSAGES" : "UNMUTE/UNBLOCK MESSAGES";
            blockButton.className = `px-10 py-4 rounded text-white text-xs font-semibold ${isBlocked ? "bg-green-500 hover:bg-green-600" : "bg-red-500 hover:bg-red-600"}`;
            ...
            inviteButton.className = `px-10 py-4 rounded text-white text-xs font-semibold 
            ...
            updateProfileButton.className = "px-10 py-4 rounded text-white text-xs font-semibold bg-blue-500 hover:bg-blue-600";
