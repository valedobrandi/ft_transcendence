  ...
  <div class="bg-black p-12 rounded shadow-lg">
    ...
    <form name="settings-form" id="settings-form" class="mb-6">
      ...
      <div class="mb-4">
        ...
        <select id="${field}" class="border border-gray-300 rounded p-2 w-full">
          ${values
          .map(
          (value) => `
      ...
      <div class="flex justify-end">
        <button id="save-settings" class="bg-blue-500 text-white px-4 py-2 rounded mr-2 hover:bg-blue-600">
          VS PLAYER
        </button>
        <button
        id="save-settings-computer" class="bg-green-500 text-white px-4 py-2 rounded mr-2 hover:bg-green-600">
          VS COMPUTER
        </button>
        <button id="cancel-settings" class="bg-gray-300 text-black px-4 py-2 rounded hover:bg-gray-400">
          Cancel
        </button>
      </div>
    </form>
